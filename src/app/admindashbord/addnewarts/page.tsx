...
function Page() {
  ...
  const handleSubmit = async (e: any) => {
    ...
    try {
      const response = await axios.post("/api/design/add", {
        name,
        description,
        price,
        url,
      ...
      <div className="flex justify-center items-center  min-h-screen min-w-screen bg-white">
        <div className="h-[60vh] sm:h-[80vh] sm:w-[50vw] flex flex-col justify-center items-center  rounded-10xl shadow-xl">
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex flex-col">
              <label htmlFor="picturela">Picture:</label>
              <input
                type="file"
                id="picture"
                name="picture"
            ...
            <div className="flex justify-center">
              <button className="border border-black pt-1 pb-1 pl-3 pr-3 rounded-lg shadow-lg" type="submit">
                Submit
              </button>
            </div>
          </form>
