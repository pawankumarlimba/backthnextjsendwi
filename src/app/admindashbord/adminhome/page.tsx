...
function page() {
  ...
  const handleLogout =async () => {
    ...
    <>
     ...
     <Button onClick={handleLogout} className="float-right m-4">Logout</Button></div>
      ...
      <div className="block sm:hidden">
        ...
        />
        <button onClick={handleLogout} className="rounded-full pl-4 pr-1 py-1 text-white flex items-center space-x-1 bg-black mt-4 text-xs font-bold dark:bg-zinc-800">
