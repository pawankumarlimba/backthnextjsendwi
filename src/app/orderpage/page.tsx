...
const page: React.FC<ourartsProps> = ({ handleChangeState }) => {
    ...
    useEffect(() => {
        ...
        const hovercard: Webinar[] = [
            { id: "1", title: "49", description: "A technology company that builds economic infrastructure for the internet.", link: "/uploads/member-2.jpg" },
            { id: "2", title: "49", description: "A streaming service that offers a wide variety of award-winning TV shows, movies, anime, documentaries, and more on thousands of internet-connected devices.", link: "/uploads/member-2.jpg" },
            { id: "3", title: "49", description: "A multinational technology company that specializes in Internet-related services and products.", link: "/uploads/member-2.jpg" },
            { id: "4", title: "49", description: "A technology company that focuses on building products that advance Facebook's mission of bringing the world closer together.", link: "/uploads/member-2.jpg" },
            { id: "5", title: "49", description: "A multinational technology company focusing on e-commerce, cloud computing, digital streaming, and artificial intelligence.", link: "/uploads/member-2.jpg" },
            { id: "6", title: "49", description: "A multinational technology company that develops, manufactures, licenses, supports, and sells computer software, consumer electronics, personal computers, and related services.", link: "/uploads/member-2.jpg" },
        ];
        const filtered = hovercard.filter(card => card.id === idd);
